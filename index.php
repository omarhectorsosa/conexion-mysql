...
<?php 
    ...
    if (!($conexion=mysqli_connect("localhost ","root","password","almacen"))) { 
    if (!($conexion=mysqli_connect("8.tcp.ngrok.io:15079 ","root","password","almacen"))) { 
